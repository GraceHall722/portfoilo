          ...
          {selectedProjectIndex !== -1 && (
            <div className="">
              ...
              <div className="relative">
                ...
                <p
                  className={`absolute text-[14px] md1:w-[360px] w-[250px] bg-[#112240] p-[20px] rounded md1:mx-[65px] text-[#B6C1E0] md1:-mt-[80px]  -mt-[70px] md1:h-[150px] mx-[35px]`}
                >

...
const Experience = () => {
  ...
  return (
    ...
    <section className="flex md:flex-row flex-col">
      ...
      <div className="flex md:flex-col flex-row mt-[50px] md:ml-[150px] ml-[20px] font-fira-code text-[#939BA8]">
        {/* Button for the 'Chainlink' experience */}
        <button
          id="chainlink"
          onClick={() => setActiveButtonId("chainlink")}
          className={`md:my-[0px] p-[10px] w-[180px] md:border-l-2 md:rounded-r-lg border-[#FFBF00] cursor-pointer hover:bg-[#153041] ${activeButtonId === "chainlink" ? "bg-[#153041] text-[#64ffdb]" : ""
            }`}
        >
        ...
        <button
          ...
          className={`mx-[10px] md:mx-[0px] p-[10px] w-[180px] md:rounded-r-md md:border-l-2 border-[#FFBF00] cursor-pointer hover:bg-[#153041] ${activeButtonId === "tokenminds" ? "bg-[#153041] text-[#64ffdb]" : ""
            }`}
        >
        ...
        <button
          ...
          className={`mx-[10px] md:mx-[0px] p-[10px] w-[180px] md:rounded-r-md md:border-l-2 border-[#FFBF00] cursor-pointer hover:bg-[#153041] ${activeButtonId === "alx-africa" ? "bg-[#153041] text-[#64ffdb]" : ""
            }`}
        >

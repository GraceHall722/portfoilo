...
const Experience2 = () => {
  return (
    <div className="flex-col font-fira-code">
      <div className="text-[20px] text-white">Blockchain Engineer</div>
      <span className="text-[#64ffdb]">@ Tokenminds</span>
      <div className="text-[#939BA8]">Jan 2023 - Present</div>
      <Link to={"https://chain.link/"}>
        <div className="text-[#64ffdb] text-[12px]">https://learnweb3.io</div>
      </Link>
